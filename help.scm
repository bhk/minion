...
;; Graph callbacks that return children and name for classes
(define (_helpCC _ class) &native (_chp+ class))
(define (_helpCN _ class) &native class)

(define (_helpOnClass goal)
  &native
  (.. "Class " goal " inherits from these other classes:\n\n"
      (_graphDeps "_helpCC" "_helpCN" nil goal)))
