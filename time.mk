...
Work.roots = $(call _multiply,{reps},{rootPatterns})
...
WorkExe.in = {inherit} {libSrcs}
WorkExe.libFlags = -lboost
WorkExe.libSrcs = a.c b.c c.c d.c e.c f.c g.c h.c i.c j.c

CC++.optFlags = -Os
CC++.warnFlags = -W -Wall

_multiply = $(foreach n,$(call _range,1,$1),$(subst <N>,$n,$2))
